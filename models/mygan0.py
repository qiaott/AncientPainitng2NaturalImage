...
class DSTN(BaseModel):
	...
	#content realA_fakeB ----qtt
        ...
        loss_Content_A = self.criterionContent(fake_B_content, real_A_content) * lambda_C
        #content realB_fakeA ----qtt
        ...
        loss_Content_B = self.criterionContent(fake_A_content, real_B_content) * lambda_D

	# combined loss
        loss_G = loss_G_A + loss_G_B + loss_cycle_A + loss_cycle_B + loss_idt_A + loss_idt_B + loss_Content_A + loss_Content_B
        loss_G.backward()
	...
	self.loss_Content_A = loss_Content_A.data[0]
	self.loss_Content_B = loss_Content_B.data[0]
